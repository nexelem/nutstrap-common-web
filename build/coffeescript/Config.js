...
(function() {
  ...
  commonModule.value('i18nGroupData', [["unknown-value", "operation_result_keys"], ["unknown-value", "confirmation_status"]]);
  ...
  commonModule.constant('TaskEntityViewMapping', [
    {
      ...
      parent_view: "brand",
      sub_view: "brand-view",
      entity_association_api: "brand"
    }, {
      entity: "brand_extra",
      parent_view: "brand",
      sub_view: "extras/extra-manage",
      entity_association_api: "brand/extra"
    }, {
      entity: "brand_rating",
      parent_view: "brand",
      sub_view: "ratings/rating-manage",
      entity_association_api: "brand/rating"
    }, {
      entity: "brand_filter_fail",
      parent_view: "brand",
      sub_view: "filterfails/filterfail-manage",
      entity_association_api: "brand/filter"
    }, {
      entity: "brand_offer",
      parent_view: "brand",
      sub_view: "offers/offer-manage",
      entity_association_api: "brand/offer"
    }, {
      entity: "brand_extended_config",
      parent_view: "brand",
      sub_view: "extendedconfig/extendedconfig-manage",
      entity_association_api: "brand/config"
    }, {
      entity: "provider",
      parent_view: "provider",
      sub_view: "provider-view",
      entity_association_api: "provider"
    }, {
      entity: "translation_entry",
      parent_view: "provider",
      sub_view: "translation/translation-manage",
      entity_association_api: "provider/translation"
    }
  ]);
  ...
  commonModule.constant('TaskableViewsConfig', ["brand-view", "brand-update", "extras/extra-manage", "ratings/rating-manage", "filterfails/filterfail-manage", "offers/offer-manage", "extendedconfig/extendedconfig-manage", "provider-view", "provider-update", "translation/translation-manage", "tsmEntity-view", "tsmEntity-update"]);
